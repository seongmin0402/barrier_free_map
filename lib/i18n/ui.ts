...
const ko: UiText = {
  ...
  route: {
    ...
    profileFastHint: "최단 거리 · 계단·승강기 무관",
    profileComfortHint: "계단 없음 · 승강기 우선",
...
const en: UiText = {
  ...
  route: {
    ...
    profileFastHint: "Shortest distance · stairs/elevators OK",
    profileComfortHint: "No stairs · elevator preferred",
    ...
    editRoute: "Edit origin & destination",
    doneEdit: "Done",
    showSteps: "Show turn-by-turn steps",
    hideSteps: "Hide turn-by-turn steps",
